let sidehacks = [
  ...
  {
    title: "Lights Out with B.L.A.S.T",
    description: "Code in the Dark : Participants use Notepad or Wordpad only and rebuild chosen HTML site",
    prize: "TBA"
  },
  {
    title: "Enterprise Holdings",
    description: "Build \"cars\" out of random supplies and race them!",
    prize: "TBD"
  },
  {
    title: "Panera + TigerHacks Meme Competition",
